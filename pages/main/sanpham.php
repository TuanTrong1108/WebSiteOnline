...
<div class = "wrapper_chitiet">
    ...
    <form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
        <div class = "chitiet_sanpham">
            ...
            <p class = "gia"> Giá SP:  <?php echo number_format($row_chitiet['giasp'],0,',','.').'đ' ?></p>
            <p> Số lượng SP còn :<?php echo $row_chitiet['soluong'] ?> </p>
            
            <p> Thông Tin  :<?php echo $row_chitiet['tomtat'] ?> </p>
            <p><?php echo $row_chitiet['noidung'] ?> </p>
            <p><input class = "goidathang" name="goidathang" type="submit" value = "Gọi đặt hàng" value = "vui lòng gọi ngay"  ></p>  
